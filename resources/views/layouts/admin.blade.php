        ...
        <aside class="w-64 min-h-screen bg-[#003d3d] shadow-lg border-r border-[#006666] flex flex-col">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.settings.index') }}" class="sidebar-link flex items-center py-3 px-4 rounded-lg text-gray-300 hover:text-white hover:bg-[#005555]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-[#30e87a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" onclick="return confirmLogout()" class="flex items-center text-sm font-medium text-gray-600 hover:text-[#30e87a] transition-colors duration-200">
