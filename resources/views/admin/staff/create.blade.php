...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-green-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-blue-100 bg-blue-50">
            <h2 class="text-xl font-semibold text-green-600">Add New Staff Member</h2>
            <p class="text-sm text-black-500 mt-1">Fill in the details below to create a new staff account</p>
        </div>
        ...
        <form action="{{ route('admin.staff.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Name Field -->
                <div class="space-y-2">
                    <label for="name" class="block text-sm font-medium text-black-600">Full Name *</label>
                ...
                <!-- Email Field -->
                <div class="space-y-2">
                    <label for="email" class="block text-sm font-medium text-black-600">Email Address *</label>
    ...
    <select name="role" id="role" class="block w-full rounded-md border-blue-200 shadow-sm focus:border-green-500 focus:ring-green-500" required>
        ...
        <option value="admin" {{ old('role', $staff->role ?? '') == 'admin' ? 'selected' : '' }}>Administrator</option>
                ...
                <!-- Department (Optional) -->
                <div class="space-y-2">
                    <label for="department" class="block text-sm font-medium text-black-600">Department</label>
